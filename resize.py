from jenksPartition import getJenksBreaks
...
def find_bounding_boxes(image):
    ...
    th2 = cv2.adaptiveThreshold(imgray, 255, cv2.ADAPTIVE_THRESH_MEAN_C, cv2.THRESH_BINARY, 5, 8)
    th3 = cv2.adaptiveThreshold(imgray, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, 5, 8)
...
(x2, y2, w, h) = cv2.boundingRect(letter_contours_bounding_box[0])
